...
{
    public class ProjectCustomersMapping:IProjectCustomersMapping
    {
        ...
        public async Task<T> Save<T>(int spType, vw_project_customers_mapping vw_project_customers_Mapping, string username)
        {
            try
            {
                SqlParameter[] parameters =
                {
                    ...
                    new SqlParameter("@master_Projects_id",vw_project_customers_Mapping.projectid),
                    new SqlParameter("@master_Customer_id",vw_project_customers_Mapping.customerid),
                    new SqlParameter("@created_By",username),
                };
                var dbResult = await SqlHelper.ExecuteProc(ConnectionCofig.ConnectionStr, Procedures.usp_ManageProjectCustomersMapping, parameters);
        ...
        public async Task<List<T>> GetById<T>(int spType, vw_project_customers_mapping request)
        {
            try
            {
                SqlParameter[] parameters =
