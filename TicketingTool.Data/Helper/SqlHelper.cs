...
namespace TicketingTool.Data.Helper
{
    /// <summary>
    ...
    public static class SqlHelper
    {
        ...
        public static Task ExecuteDatasetAsync(string connectionStr, object proceduresusp_ManageUser)
        {
        ...
        public static Task ExecuteProc(object connectionStr, string usp_ManageTool, SqlParameter[] parameters)
        {
            throw new NotImplementedException();
        }
        ...
        public static Task<DataSet> ExecuteProc(string connectionString, string spName, SqlParameter[] SqlParam)
        {
            return ExecuteDatasetAsync(connectionString, CommandType.StoredProcedure, spName, SqlParam);
        }
