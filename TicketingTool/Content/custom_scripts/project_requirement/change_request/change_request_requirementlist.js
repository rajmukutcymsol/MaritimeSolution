...
$(document).ready(function () {
    ...
    $('#request_status').change(function () {
        ...
        if (selectedValues == "00000000-0000-0000-0000-000000000000") {
            ...
            $.ajax({
                url: "/ChangeRequest/GetAll_Filter",
                    ...
                    "columns": [
                        {
                            ...
                            "orderable": false,
                            "render": function (data, type, row, meta) {
                                return '<input type="hidden" value=' + data + '> <a href="/ChangeRequest/Edit/' + data + '" style="margin-right: 5px;"><i class="fa fa-edit"></i></a>| &nbsp <a href="#" class="btnDelete" style="margin-right: 5px;"><i class="fa fa-trash"></i></a>';
                            },
                        },
                        { 'data': 'auto_id' },
                        { 'data': 'project_name' },
                        ...
                        { 'data': 'priority_name' },
                        { 'data': 'status_name' },
                        { 'data': 'requester' },// "orderable": false }, // Disable sorting for "Requester" column
                        {
                            'data': 'is_resolution_offered',
                            'searchable': false,
                            'orderable': false,
                    ...
                    columns: [
                        {
                            ...
                            "orderable": false,
                            "render": function (data, type, row, meta) {
                                return '<input type="hidden" value=' + data + '> <a href="/ChangeRequest/OthersEdit/' + data + '" style="margin-right: 5px;"><i class="fa fa-edit"></i></a>';
                                //return '<a href="/ChangeRequest/Edit/' + data + '" style="margin-right: 5px;"><i class="fa fa-edit"></i></a>';
                            },
                        },
                        { 'data': 'auto_id' },
                        { 'data': 'project_name' },
