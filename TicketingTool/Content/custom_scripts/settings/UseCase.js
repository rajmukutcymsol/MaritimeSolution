...
function loadData() {
    $.get("/UseCase/GetAll", function (data) {
...
function update() {
    ...
    var request = {
        ...
        is_active: is_active,
        //id: $("#id").val(),
        id: $("#id").val($(this).closest('tr').find('td:eq(0) input').val())
    }
...
$('body').on('click', '.btnEdit', function () {
    ...
    $.get("/UseCase/GetById", { id: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
...
$('body').on('click', '.btnDelete', function () {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get("/UseCase/Delete", { id: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
                    swal(data.Title, data.Message, data.Type).then(function () {
                        loadData();
                    });
                });
