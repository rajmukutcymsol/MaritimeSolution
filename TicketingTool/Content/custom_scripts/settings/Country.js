...
function loadData() {
    $.get("/Country/GetAll", function (data) {
...
$('body').on('click', '.btnEdit', function () {
    $.get("/Country/GetById", { CountryID: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
...
$('body').on('click', '.btnDelete', function () {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get("/Country/Delete", { CountryID: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
                    swal(data.Title, data.Message, data.Type).then(function () {
                        loadData();
                    });
                });
