...
function loadData() {
    $.get("/ProjectManager/GetAll", function (data) {
        $('#tbl_project_manager').DataTable({
...
$('body').on('click', '.btnEdit', function () {
    ...
    $.get("/ProjectManager/GetById", { id: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
...
$('body').on('click', '.btnDelete', function () {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get("/ProjectManager/Delete", { id: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
                    swal(data.Title, data.Message, data.Type).then(function () {
                        loadData();
                    });
                });
