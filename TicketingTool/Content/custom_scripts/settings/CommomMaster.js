...
function loadData() {
    $.get("/CommonMaster/GetAll", function (data) {
        $('#tbl_cliui').DataTable({
            ...
            "columns": [
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return '<input type="hidden" value=' + data + '> <a href="/CommonMaster/Edit/' + data + '" style="margin-right: 5px;"><i class="fa fa-edit"></i></a>| &nbsp <a href="#" class="btnDelete" style="margin-right: 5px;"><i class="fa fa-trash"></i></a>';
                    },
                },
                { 'data': 'CategoryName' },
                { 'data': 'CompanyName' },
...
$('body').on('click', '.btnEdit', function () {
    ...
    $.get("/CommonMaster/GetById", { id: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
...
$('body').on('click', '.btnDelete', function () {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get("/CommonMaster/Delete", { id: $(this).closest('tr').find('td:eq(0) input').val() }, function (data) {
                    swal(data.Title, data.Message, data.Type).then(function () {
                        loadData();
                    });
                });
