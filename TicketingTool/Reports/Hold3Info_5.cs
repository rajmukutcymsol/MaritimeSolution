...
namespace TicketingTool.Reports {
    ...
    public class Hold3Info_5 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TicketingTool.Reports.Hold3Info_5.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedHold3Info_5 : Component, ICachedReport {
        
        public CachedHold3Info_5() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Hold3Info_5 rpt = new Hold3Info_5();
            rpt.Site = this.Site;
            return rpt;
        }
