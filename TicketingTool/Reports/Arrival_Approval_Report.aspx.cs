...
{
    public partial class Arrival_Approval_Report : System.Web.UI.Page
    {
    ...
    SELECT
        ...
        [readiness_accepted],
        [arrival_at],
        'FORE= '+fwd+' /'+' AFTER= '+ aft as draft_on_arrival,
        'FO= '+fo+' DO= '+doo+' FW=' +fw as bunker_rob_on_arrival, 
        [lat],
        [longi],
        [draft_on_departure],
    ...
    FROM [dbo].[Arrival_Sailing_Condition] ir
...
DataTable dtReportMain = Execute_Procedures_Select_ByQuery(strSQLMain);
            ...
            rd.Load(Server.MapPath("rptArraivalDepartureReport.rpt"));
